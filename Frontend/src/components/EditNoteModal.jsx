...
import { updateApiNote } from '../Services';
    ...
    return (
        <Modal isOpen={props.isOpen} onClose={props.onClose}>
            ...
            <FormGroup>
                ...
                <Input type="text" id="title" name="title" value={formData.title} onChange={handleInputOnChange} error={errors.title} />
                {errors.title && <span style={{ color: 'red' }}>{errors.title}</span>}
            </FormGroup>
            <FormGroup>
                <Label htmlFor="content">Content</Label>
                <Textarea id="description" name="content" value={formData.content} onChange={handleInputOnChange} error={errors.content} />
